...
element = np.array(['Sc','Ti','V','Cr','Mn','Fe','Co','Ni','Cu','Zn','Y','Zr','Nb','Mo','Tc','Ru','Rh','Pd','Ag','Cd','Lu','Hf','Ta','W','Re','Os','Ir','Pt','Au','Hg'])

for guest1 in element:
	filename = 'Zone2_' + guest1.lower()
	...
	with open('py/' + filename + '.py', 'w') as f:
		...
		"import numpy as np\n"\
                "\n"\
		"atoms = hcp0001('Pt', size=(3,3,7), vacuum=7.5, a=3.993/2**0.5, orthogonal=False)\n"\
                "\n"\
