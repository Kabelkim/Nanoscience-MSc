...
atomic_radii = [184, 176, 171, 166, 161, 156, 152, 149, 145, 142, 212, 206, 198, 190, 178, 173, 169, 165, 225, 208, 200, 193, 188, 185, 180, 177, 174, 171]
atomic_radii_1 = atomic_radii[:9]
atomic_radii_2 = atomic_radii[10:18]
atomic_radii_3 = atomic_radii[18:]
...
#cbar = plt.colorbar(ax1.scatter(a3,e3,  c=atomic_radii, cmap='jet'))
#cbar.ax.set_ylabel('Atomic radius (pm)')
ax2 = ax1.twiny()
...
#plt.savefig("Pt_host_with_radii_colors.png")
plt.show()
...
ax1.scatter(atomic_radii_1, e1_1, color = cl[0])
ax1.scatter(atomic_radii_2, e1_2, color = cl[1])
ax1.scatter(atomic_radii_3, e1_3, color = cl[2])

ax1.plot(atomic_radii_1, e1_1, color = cl[0], label="3d metals")
ax1.plot(atomic_radii_2, e1_2, color = cl[1], label="4d metals")
ax1.plot(atomic_radii_3, e1_3, color = cl[2], label="5d metals")
ax1.scatter(169,0, s=150, marker = "x", c="k", label="host")
ax1.legend(loc="lower right")
ax1.set_ylabel("Adsorption Energy (eV)")
ax1.set_xlabel("Atomic radii (pm)")
ax1.set_title("Pd host - Thrid layer")
plt.savefig("sorted_1_345d.png")
plt.show()
