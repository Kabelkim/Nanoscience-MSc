...
os.system("mkdir err")
os.system("mkdir log")
host_l = ['Hf','Ta','W','Re','Os','Ir','Pt','Au','Hg']
lattice_a = ['3.36','3.31','3.16','3.51','3.444125','3.571','3.83','3.924','4.08','3.005']
...
for i in range(1,4):
	...
	for host in host_l:
		...
		for guest1 in elements:
			filename = host + '_' + guest1 +'_'+str(i)
